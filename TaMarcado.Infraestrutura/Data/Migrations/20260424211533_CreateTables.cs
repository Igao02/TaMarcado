        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LimitMonthlySchedulings = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExibitionName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    KeyPix = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    KeyPixType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Professional", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Professional_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Professional_Categorie_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvaliableTime", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AvaliableTime_Professional_ProfessionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blocked_Professional_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "Professional",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Client_Professional_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "Professional",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscription_Professional_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "Professional",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusNotification = table.Column<int>(type: "int", nullable: false),
                    DateScheduling = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationScheduling", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotificationScheduling_Scheduling_SchedulingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProofUrl = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payment_Scheduling_SchedulingId",
                        column: x => x.SchedulingId,
                        principalTable: "Scheduling",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvaliableTime_ProfessionalId",
                table: "AvaliableTime",
                column: "ProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_Blocked_ProfessionalId",
                table: "Blocked",
                column: "ProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_Client_ProfessionalId",
                table: "Client",
                column: "ProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationScheduling_SchedulingId",
                table: "NotificationScheduling",
                column: "SchedulingId");

            migrationBuilder.CreateIndex(
                name: "IX_Payment_SchedulingId",
                table: "Payment",
                column: "SchedulingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Professional_ApplicationUserId",
                table: "Professional",
                column: "ApplicationUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Professional_CategoryId",
                table: "Professional",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscription_ProfessionalId",
                table: "Subscription",
                column: "ProfessionalId");
        }
